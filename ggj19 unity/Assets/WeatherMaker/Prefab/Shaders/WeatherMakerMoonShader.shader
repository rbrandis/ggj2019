...
Shader "WeatherMaker/WeatherMakerMoonShader"
{
	...
	SubShader
	{
		...
		static const fixed3 tintColor = _TintColor.rgb * _TintColor.a;
		...
		fixed4 frag(vertexOutput i) : SV_TARGET
		{
			...
			else
			{
				...
				fixed3 lightFinal = _WeatherMakerSunColor.rgb * lightNormal * tintColor;
				...
				moonColor.a *= lerp(1.0, 0.5, min(1.0, _WeatherMakerSunColor.a));
